...
Now we can apply PCA to the NSD data and compute the PC scores. There are several ways to visualize these PCs.
...
The first method is to view the stimuli with the highest or lowest scores along a given PC. It provides simple clues of what this PC might be sensitive to, which could be features ranging from low to high complexity level.
