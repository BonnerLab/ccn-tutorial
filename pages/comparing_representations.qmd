...
Comparing different representations of the same stimuli is integral to the study of sensory neuroscience. Every computational model of a system must be effectively related to experimental data for validation -- and this necessitates the comparison of two high-dimensional datasets.

Before comparing any representations, we must decide what transformations of a representation preserve its identity -- or what invariances we would like to enforce.

As a simple visual example, let's take the CCN logo -- which can be interpreted as a cloud of data points in two dimensions -- and apply various transformations to it.

![](/resources/ccn.svg){fig-align="center" height=30mm}
...
$X \rightarrow X + \text{constant}$
:::

### Scaling (isotropic)

![](/resources/ccn.svg){fig-align="center" height=15mm}

::: {.callout-tip}
# What is an isotropic scaling?

$X \rightarrow \text{constant}(X)$
:::

### Scaling (anisotropic)

::: {.callout-tip}
# What is an anisotropic scaling?

$$ X \rightarrow \begin{bmatrix}
\alpha & 0 \\
0 & \beta 
\end{bmatrix}\text{constant}(X)$$
:::
...
![](/resources/ccn-shear.svg){fig-align="center" height=30mm}

### Nonlinear magic

![](/resources/ccn-nonlinear.svg){fig-align="center" height=60mm}

## Linear regression

Is an overall $R^2$ a good metric to compare two systems? Well, yes.
