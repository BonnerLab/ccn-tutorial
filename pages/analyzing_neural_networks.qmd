...
abstract: Deep networks are considered to be black boxes because we cannot answer fundamental questions about their inner workings. In this part of the tutorial, we will show how to measure the dimensionality of representations and weights of deep networks. We will also compare networks trained from different initializations to assess the similarity of their representations and weights.
---
...
![Sample images from CIFAR-10](https://github.com/BonnerLab/ccn-tutorial/blob/main/resources/cifar.png?raw=true)
...
![A simple 2-layer perceptron](https://github.com/BonnerLab/ccn-tutorial/blob/main/resources/mlp.svg?raw=true)
...
$$ C = \frac{1}{n_1} W_1^\top W_1 $$

![](https://github.com/BonnerLab/ccn-tutorial/blob/main/resources/weights_pca.svg?raw=true){width=50%}
...
![](https://github.com/BonnerLab/ccn-tutorial/blob/main/resources/weights_svd.svg?raw=true){width=100%}
...
We wish to compute the best orthogonal alignment matrix $A$ that aligns two representations $\varphi(x)$ to $\psi(x)$:
...
![](https://github.com/BonnerLab/ccn-tutorial/blob/main/resources/activation_alignment.png?raw=true){width=100%}
...
[Note that the eigenvectors of a matrix are determined up to a reverse in direction. This means that $v$ and $-v$ correspond to the same eigenvector. To this end, to compare two sets of eigenvectors, we look at the absolute values of the entries of the change of basis matrix.]{.aside}

```{python}
# | code-summary: Compare eigenvalues and eigenvectors of the activation covariances of both networks
...
![](https://github.com/BonnerLab/ccn-tutorial/blob/main/resources/weight_alignment.png?raw=true){width=100%}

```{python}
# | code-summary: Compare eigenvalues and eigenvectors of the weight covariances of both networks
...
![](https://github.com/BonnerLab/ccn-tutorial/blob/main/resources/cnn.svg?raw=true)
...
This corresponds to $n = C_{\rm out}$ neurons which compute linear projections over patches, of dimension $d = C_{\rm in} \times k_{\rm h} \times k_{\rm w}$.
