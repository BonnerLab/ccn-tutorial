...
![TODO update with schematic showing viewing natural images](assets/mouse.svg){width=20%}
...
::: {.column-page-right}
![](assets/autocovariance-eigendecomposition.svg){width=100%}
:::
...
![TODO update with Stringer figure](assets/mouse.svg){width=20%}

![TODO update with zebrafish figure](assets/zebrafish.svg){width=5%}
