...
author:
  - name:
    ...
    affiliation:
      - ref: jhu
    roles:
      - [conceptualization, methodology, investigation, analysis, writing, editing]
  - name:
      given: Florentin
      family: Guth
...
| Deep neural networks | [website](https://bonnerlab.github.io/ccn-tutorial/pages/deep_neural_networks.html) | [Colab](https://colab.research.google.com/github/BonnerLab/ccn-tutorial/blob/main/notebooks/deep_neural_networks.ipynb) | [download](https://bonnerlab.github.io/ccn-tutorial/pages/deep_neural_networks.ipynb) |
