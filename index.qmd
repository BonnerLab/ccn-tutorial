...
Each section is a [computational notebook](https://docs.jupyter.org/en/latest/index.html) that can be run on [Google Colab](https://colab.research.google.com/) -- just follow the links above! If you can't run the notebooks, just follow along on the website!
:::
